...
modeSwitch.addEventListener('input', function (event) {
  if (root.style.getPropertyValue('--pink-gradient') === 'radial-gradient(circle, rgba(153,155,161,1) 35%, rgba(89,91,94,1) 100%)') {
    ...
    root.style.setProperty('--pink-gradient', 'radial-gradient(circle, rgba(153,155,161,1) 35%, rgba(89,91,94,1) 100%)')
